...
- **All firmly-sourced allowances seeded as of Sprint 2.1 (2026-04-28, migration 0008).** 8 allowance rows total: 2 leading-hand (all_purpose, week), first aid (additive, week), 3 cold-work bands (additive, hour: low/mid/high), meal (additive, event), vehicle (additive, km). Schema unit enum extended in same migration per ADR-011.
